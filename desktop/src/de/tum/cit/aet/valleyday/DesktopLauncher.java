...
/**
 * The DesktopLauncher class is the entry point for the desktop version of the Valley Day game.
...
public class DesktopLauncher {
	...
	public static void main(String[] arg) {
		...
		// Launch the game
		new Lwjgl3Application(new ValleyDayGame(new DesktopFileChooser()), config);
	}
}
